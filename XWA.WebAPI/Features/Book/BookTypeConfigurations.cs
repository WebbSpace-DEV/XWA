...
/// <summary>
/// The book type configurations class.
/// </summary>
public class BookTypeConfigurations : IEntityTypeConfiguration<BookModel>
{
    /// <summary>
    /// The code-first migration configuration method.
    /// </summary>
    /// <param name="builder">The entity type builder object, used in code-first migrations.</param>
