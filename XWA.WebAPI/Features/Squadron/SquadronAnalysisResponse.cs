...
/// <summary>
/// The squadron analysis response model class.
/// </summary>
public class SquadronAnalysisResponse : SquadronBase, IAnalytical
{
    /// <summary>
    /// The constructor for the squadron analysis response model.
    /// </summary>
    /// <param name="id">The id of the squadron.</param>
    public SquadronAnalysisResponse(
        string id) : base(id)
    {
        Id = id;
    }
