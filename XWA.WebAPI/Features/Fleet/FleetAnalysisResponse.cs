...
/// <summary>
/// The fleet analysis response model class.
/// </summary>
public class FleetAnalysisResponse : FleetBase, IAnalytical
{
    /// <summary>
    /// The constructor for the fleet analysis response model.
    /// </summary>
    public FleetAnalysisResponse() : base()
    {
    }
